...
<%@include file="outline/header.jsp"%>
  ...
  <div class="row col-lg-12 d-flex justify-content-center">
      <form action="LoginServlet" class="row col-lg-6 " id="loginPanel" style="background: white; position: fixed; height: auto; z-index: 10; display: none">
      ...
      <div id="login">
        <table width="100%">
          <tr>
            ...
            <td>
                <input type="text" name="txtUsername" size="30" style="height: 35px">
            </td>
          </tr>
        </table>
        <table width="163%">
          <tr>
            ...
            <td>
                <input type="password" name="txtPassword" size="30" style="height: 35px">
            </td>
          </tr>
        </table>
        <table>
