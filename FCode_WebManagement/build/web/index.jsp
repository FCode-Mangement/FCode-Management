<%-- 
    Document   : index
    Created on : May 17, 2018, 1:19:59 PM
    Author     : DAT
--%>
...
<body style="background-color: #FBEAFF;">
    ...
    <div class="row col-lg-12 d-flex justify-content-center">
        <form action="LoginServlet" name="btnLogin" method="POST" class="row col-lg-6 " id="loginPanel" 
              style="background: white; position: fixed; height: auto; z-index: 10; display: none">
            ...
            <hr> <div id="login">
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="txtUsername" value="" size="30" style="height: 35px">
                        </td>
                    </tr>
                </table>
                <table width="163%">
                    <tr>
                        ...
                        <td>
                            <input type="password" name="txtPassword" value="" size="30" style="height: 35px">
                        </td>
                    </tr>
                </table>
                <table>
    ...
    <div class="container pb-3 mb-5" id="wrap-content-forum-p">
        <img src="img/pin.png" class="pin-p">
        <!--           heading-->
        <div class="row-md-5 text-center pt-2">
            <h3 id="heading-forum-p"><strong>JOIN OUR FORUM</strong></h3>
        </div>
        <!--            end of heading-->
        ...
        <div class="row justify-content-center">
            <a href="#" class="col-lg-4 text-center my-5 mx-5 home-gallery-p px-0">
                    <img src="img/forum/forum1.jpg" class="gallery-item-p" width="380" height="auto">
                    <h4 class="gallery-item-title-p">
                        Title
                    </h4>
                </a>
            <a href="#" class="col-lg-4 text-center my-5 mx-5 home-gallery-p px-0">
                    <img src="img/forum/forum2.jpg" class="gallery-item-p" width="380" height="auto">
                    <h4 class="gallery-item-title-p">
                        Title
                    </h4>
                </a>
        ...
        <div class="row justify-content-center">
            <a href="#" class="col-lg-4 text-center my-5 mx-5 home-gallery-p px-0">
                    <img src="img/forum/forum3.jpg" class="gallery-item-p" width="380" height="auto">
                    <h4 class="gallery-item-title-p">
                        Title
                    </h4>
            ...
            <a href="#" class="col-lg-4 text-center my-5 mx-5 home-gallery-p px-0">
                    <img src="img/forum/forum4.jpg" class="gallery-item-p" width="380" height="auto">
                    <h4 class="gallery-item-title-p">
                        Title
                    </h4>
                </a>
        ...
        <!--            end of row 2-->
        <!--       view more button-->
        <div class="row-md-5 text-center pb-3">
            <a href="#" class="home-view-more-p">
                    VIEW MORE
